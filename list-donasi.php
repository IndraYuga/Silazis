  ...
  <div class="mt-5">.</div>
                <div class="p-4 " style="padding:10px;" >
                            ...
                            if(isset($_GET['searchText'])){
                                ...
                                $sql = "SELECT * FROM tb_user WHERE nama Like '%$searchText%' AND nama != 'admin'";
                            }else{
                            ...
                            <tbody>';
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td class="font text-center align-middle">' . $row['nominal'] . '</td>';
                                    echo '<td class="font text-center align-middle">' . $row['keterangan'] . '</td>';
                                    echo '<td class="font text-center align-middle">' . $row['tanggal'] . '</td>';
                                    echo '<td class="text-center font align-middle"><img src="images/donasi/' . $row['gambar'] . '" class="img-thumbnail" height="10px" style="max-width: 60px; max-height: 60px; min-width: 60px; min-height: 60px ;" height="10px"></td>';
                                    echo '<td class="text-center align-middle">' .
                                        ...
                                        '<li>' .
                                        '<a href="bukti-donasi.php?id_donasi=' . $row['id_donasi'] . '" class="btn btn-warning dropdown-item rounded-0 font text-success">
                                        <i class="fa-solid fa-eye"></i>
                                        Lihat
                                        </a>' .
                                        '</li>' .
                                        ...
                                        '<li>' .
                                        '<a href="kuitansi.php?id_donasi=' . $row['id_donasi'] . '" class="btn btn-warning dropdown-item font text-warning rounded-0" >
