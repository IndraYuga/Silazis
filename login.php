...
<div class="hero_area">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                        <form action="function/proses-login.php" method="post">
                            <div class="mb-3">
                                <label for="hp" class="form-label">Nomor HP</label>
                                <input type="text" placeholder="Masukkan hp" class="form-control" id="hp" name="hp" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="text-center mt-4">
                              <a href="daftar.php"><h8>belum punya akun?</h8></a>
                            </div>
                            <div class="text-center mt-4">
                                <section class="recipe_section">
                                    <button type="submit_admin" class="btn btn-primary shadow-sm form-control" style="padding-right:20px; padding-left:20px;">Login</button>
                                </section>
                            </div>
                        </form>
                    </div>
  ...
  <script src="js/custom.js"></script>
    ...
    <script>
        // Tampilkan atau sembunyikan password saat tombol "Preview Password" diklik
