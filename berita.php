...
?>
    ...
    <br>
      ...
      if (isset($_GET['id_artikel'])) {
        ...
        $sql = "SELECT * FROM tb_artikel WHERE id_artikel = $id_artikel";
      ...
      <div class="position-relative mb-3">
        <img class="img-fluid w-100" src="images/<?php echo $row['gambar']; ?>" style="object-fit: cover;">
        <div class="bg-white border border-top-0 p-4">
            <div class="mb-3">
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                    href=""><?php echo $row['kategori']; ?></a>
                <a class="text-body" href=""><?php echo $tanggalKonversi; ?></a>
            </div>
            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"><?php echo $row['judul']; ?></h1>
            <?php echo $row['isi']; ?>
        </div>
        <?php
        }else{
